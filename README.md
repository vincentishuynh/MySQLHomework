...
## Input the ID of the product you need to buy
...
## Input the amount of Units you need
...
## Checking if Units is not 0 and if there's enough units available; it will console.log the total the user has to pay
...
## If you input more units the database has...
...
## The code will run the check function again and console.log INSUFFICIENT QUANTITY!
